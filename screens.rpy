...
init -501 screen quick_menu():
    ...
    if quick_menu:
        ...
        hbox:
            ...
            textbutton _("Проруск") action Skip()
        ...
        if not persistent.autoload or not main_menu:
            ...
            if main_menu:
                ...
                if persistent.playthrough == 1:
                    ...
                    textbutton _("Новая игра") action If(persistent.playername, true=Start(), false=Show(screen="name_input", message="Пожалуйста, введите имя", ok_action=Function(FinishEnterName)))
            ...
            if renpy.variant("pc"):
                ...
                textbutton _("Помощь") action [Help("README.html"), Show(screen="dialog", message="Файл справки открыт в вашем браузере.", ok_action=Hide("dialog"))]
        ...
        vbox:
            ...
            hbox:
                ...
                if config.developer:
                    vbox:
                        ...
                        textbutton _("Выключено") action Preference("rollback side", "disable")
            ...
            hbox:
                ...
                vbox:
                    ...
                    label _("Время автоматической перемотки")
                ...
                vbox:
                    ...
                    if config.has_music or config.has_sound or config.has_voice:
                        ...
                        textbutton _("Отключить для всех"):
