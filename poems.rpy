...
I flicker back."""
    ...
    poem_yt1 = Poem(
    author = "yuri",
    title = "Призрак под светом",
    text = """\
Щупальца моих волос сияют под янтарным светом.
Купаюсь.
Должно быть, это он —
Последний уличный фонарь, выдержавший испытание временем,
Последний, который ещё не заменён отвратительным голубовато-зелёным сиянием будущего.
Я купаюсь. Спокойно; вдыхаю воздух настоящего, но живу в прошлом.
Свет мерцает.
Я мерцаю в ответ."""
)
...
And I feed myself again."""
    ...
    title = "Енот",
    text = """\
Это произошло глубокой ночью, когда я резал хлеб для виноватого перекуса.  
Моё внимание привлёк шорох енота за окном.  
Думаю, это был первый раз, когда я заметил свои странные склонности как необычный человек.  
Я дал еноту кусок хлеба, подсознательно прекрасно понимая последствия.  
Понимая, что накормленный енот всегда вернётся за добавкой.  
Привлекательная красота моего ножа — это симптом.  
Хлеб — моя голодная любопытность.  
Енот — порыв.  

Луна меняет фазу и отражает ещё больше света от моего ножа.  
Тот самый свет, что блестит в глазах моего енот-друга.  
Я нарезаю хлеб, свежий и мягкий. Енот возбуждён.  
Или, возможно, я просто проецирую свои эмоции на недавно удовлетворённое животное.  

Енот стал следовать за мной.  
Можно сказать, что мы довольно привыкли друг к другу.  
Енот всё чаще голоден, поэтому мой хлеб всегда под рукой.  
Каждый раз, когда я размахиваюсь ножом, енот показывает своё волнение.  
Прилив крови. Классическое павловское условие. Я нарезаю хлеб.  
И снова кормлю себя."""
)
...
But that's about it."""
    ...
    poem_nt1 = Poem(
    author = "natsuki",
    title = "Орлы умеют летать",
    text = """\
Обезьяны умеют лазить  
Сверчки умеют прыгать  
Лошади умеют скакать  
Совы умеют искать  
...
Эми любит пауков.  
Гадких, шевелящихся, волосатых, уродливых пауков!  
Вот почему я не дружу с ней.  

У Эми милый голос для пения.  
Я слышала, как она пела мою любимую песню о любви.  
Каждый раз, когда она пела припев, моё сердце билось в такт словам.  
Но она любит пауков.  
Вот почему я не дружу с ней.  

Однажды я сильно поранила ногу.  
Эми помогла мне встать и отвела к медсестре.  
Я старалась не позволить ей меня трогать.  
Она любит пауков, значит, её руки, наверное, отвратительные.  
Вот почему я не дружу с ней.  

У Эми много друзей.  
Я всегда вижу, как она разговаривает с людьми.  
Наверное, она говорит о пауках.  
А что если её друзья тоже начнут любить пауков?  
Вот почему я не дружу с ней.  

Не важно, если у неё есть другие хобби.  
Не важно, если она держит это в секрете.  
Не важно, если это никому не вредит.  

Это отвратительно.  
Она отвратительна.  
Мир будет лучше без любителей пауков.  
...
I want breakfast."""
    ...
    poem_st1 = Poem(
    author = "sayori",
    title = "Дорогие лучики солнца",
    text = """\
То, как ты светишь сквозь мои жалюзи по утрам,
Заставляет меня чувствовать, будто ты скучало по мне.
Целуешь меня в лоб, помогая выбраться из постели.
Заставляешь меня протереть сонные глаза.

Ты зовёшь меня выйти поиграть?
Доверяешь мне прогнать дождливый день?
Я смотрю вверх. Небо голубое.
Это секрет, но я тоже доверяю тебе.

Если бы не ты, я могла бы спать вечно.
Но я не злюсь.
...
Inside my head."""
    ...
    title = "Бутылочки",
    text = """\
Я открываю свою голову, как крышку от банки с печеньем.
Это тайное место, где я храню все свои мечты.
Маленькие шарики солнечного света, трущиеся друг о друга, как клубок котят.
Я просовываю туда большой и указательный пальцы и достаю один.
Он тёплый и немного покалывает.
Но нельзя терять время! Я кладу его в бутылку, чтобы сохранить.
И ставлю бутылку на полку рядом со всеми остальными.
Счастливые мысли, счастливые мысли, счастливые мысли в бутылках, все в ряд.

Моя коллекция приносит мне много друзей.
Каждая бутылка — как звёздный свет, чтобы всё исправить.
Иногда мой друг чувствует себя плохо.
И тогда с полки спускается бутылка, чтобы спасти день.

Ночь за ночью — всё больше мечт.
Друг за другом — всё больше бутылок.
Мои пальцы уходят всё глубже и глубже.
Словно я исследую тёмную пещеру, открывая секреты,
скрытые в её уголках и трещинах.
Копаю и копаю.
Скребу и скребу.

Я сдуваю пыль с крышек своих бутылок.
Кажется, будто времени и не прошло.
Моей пустой полке не помешало бы ещё немного.
Мои друзья смотрят сквозь запертую входную дверь.

Наконец всё готово. Я открываю дверь, и входят мои друзья.
Они заходят так торопливо. Неужели им так сильно нужны мои бутылки?
Я в панике хватаю их с полки, одну за другой.
Протягиваю их каждому из друзей.
Каждую бутылку.
Но каждый раз, когда я отпускаю одну,
она разбивается о плитку у моих ног.
Счастливые мысли, счастливые мысли, счастливые мысли осколками по всему полу.

Они должны были быть для моих друзей, для друзей, которые не улыбаются.
Они все кричат, умоляют… что-то.
Но всё, что я слышу — это эхо, эхо, эхо, эхо, эхо
Внутри моей головы."""
)
...
And he, on the other side, was looking in."""
    ...
    text = """\
Это не могла быть я.
Смотри, в какую сторону выпирает штукатурка.
Шумный сосед? Разъярённый парень? Я никогда не узнаю. Меня не было дома.
Я заглядываю внутрь в поисках подсказки.
Нет! Я ничего не вижу. Меня шатает, я слепну, как киноплёнка, оставленная на солнце.
Но уже слишком поздно. Моя сетчатка.
Она уже выжжена навсегда бессмысленным изображением.

Это всего лишь маленькая дыра. Она не была слишком яркой.
Она была слишком глубокой.
Тянулась бесконечно — во всё и сразу.
Дыра бесконечного выбора.

И теперь я понимаю,
что я смотрела не внутрь.
Я смотрела наружу.
А он, по ту сторону,
смотрел внутрь.
"""
...
Load Me
    ...
    title = "Спаси меня",
    text = """\
Цвета, они не прекращаются.
Яркие, прекрасные цвета
Мелькают, расширяются, пронзают
...
Жестокие, режущие волны
Скрипят, визжат, пронзают
Синус, косинус, тангенс
    Словно проигрываешь школьную доску на проигрывателе
        Словно проигрываешь винил на корке пиццы
Бесконечное
стихотворение
из бессмысленного\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n
Загрузи меня
...
style sayori_text:
    font "fonts/Sayori font.ttf"
    size 34
    color "#000"
    outlines []

style monika_text:
    font "fonts/Monika font.ttf"
    size 34
    color "#000"
    outlines []
