init python:
    menu_trans_time = 1
    splash_message_default = "Если вы здесь ради нормальной логики — возможно, вы ошиблись игрой."
    splash_messages = [
    "You are my sunshine,\nMy only sunshine",
    "I missed you.",
    "Play with me",
...
label splashscreen:
    ...
    if not persistent.first_run:
        ...
        with Dissolve(1.0)
        pause 1.0
        "Just a little story - является фанатской работой и не связан с Team Salvato."
        "Все персонажи принадлежат Doki Doki Literature Club! А все плохие шутки — разработчику этого мода."
        "Перед прохождением мода стоит пройти оригинальную игру во избежания спойлеров."
        "Данные для игры вы можете найти здесь https://ddlc.moe/ или в Steam."
        "В этой игре всё на русском, кроме твоего имени. Имя нужно вводить английскими буквами."
        "Если попытаешься использовать русский — твоя игра не взорвётся."
        "Зато персонажи будут смотреть на твоё имя так, будто ты только что вызвал древнее проклятие. Так что будь осторожен и уважай клавиатуру!"
        "В этом моде поэзия не обязана иметь смысл, главный герой безспорно гениален, а всё остальное — полный хаос."
        "Если вы ожидали спокойную игру — попрощайтесь с нормальной логикой прямо сейчас."
        "И если вдруг всё покажется слишком логичным — скорее всего, вы загрузили не тот мод."
        menu:
