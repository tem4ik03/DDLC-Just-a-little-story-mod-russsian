...
define gui.text_font = "fonts/fonts-fonts.ttf"
# ===== ШРИФТ ДЛЯ РУССКОГО ТЕКСТА =====
# Шрифт для текста диалогов
define gui.text_font = "fonts/fonts-fonts.ttf"

# Шрифт для имён персонажей
define gui.name_font = "fonts/fonts-fonts.ttf"

# Шрифт для интерфейса (меню, кнопки)
define gui.interface_font = "fonts/fonts-fonts.ttf"
# ====================================
init -1:
    style edited2 is say_dialogue:
        font "fonts/fonts-fonts.ttf"
        outlines [(18, "#000000", 0, 0)]
        size 27            
        line_spacing 10 
